# main_agno_final_real.py - ARIA-SDR com AgentOS real (sem dependÃªncias problemÃ¡ticas)
...
# Setup ARIA agent (sem modelo especÃ­fico para evitar problemas)
aria_agent = Agent(
    id="aria-sdr-agent",
    name="ARIA-SDR",
    db=db,
...
print("Iniciando servidor AgentOS...")

if __name__ == "__main__":
    agent_os.serve(app="main_agno_final_real:app", reload=True)
