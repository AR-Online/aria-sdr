# main_agno_default.py - ARIA-SDR com AgentOS usando modelo padrÃ£o
...
print("Configurando ARIA-SDR AgentOS com modelo padrÃ£o...")

# Setup the database
db = SqliteDb(id="aria-db", db_file="tmp/aria.db")

# Setup ARIA agent sem modelo explÃ­cito (usarÃ¡ padrÃ£o)
aria_agent = Agent(
    id="aria-sdr-agent",
    name="ARIA-SDR",
    db=db,
...
if __name__ == "__main__":
    agent_os.serve(app="main_agno_default:app", reload=True)
