# main_agno_official.py - ARIA-SDR com AgentOS oficial conforme documenta̤̣o
...
print("Configurando ARIA-SDR AgentOS conforme documenta̤̣o oficial...")

# Setup the database
db = SqliteDb(id="aria-db", db_file="tmp/aria.db")

# Setup ARIA agent conforme documenta̤̣o
aria_agent = Agent(
    id="aria-sdr-agent",
    name="ARIA-SDR",
    db=db,
...
# Setup our AgentOS app conforme documenta̤̣o
agent_os = AgentOS(
...
print("AgentOS pronto para uso na porta 7777!")

if __name__ == "__main__":
    agent_os.serve(app="main_agno_official:app", reload=True)
